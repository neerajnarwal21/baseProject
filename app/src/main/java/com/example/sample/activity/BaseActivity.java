...
import com.example.sample.utils.PermissionsManager;
...
import static com.example.sample.utils.UtilsKt.debugLog;
...
//        checkDate();
    ...
    @Override
    public void onSuccess(@NotNull Call<?> call, @NotNull String message, @NotNull Object payload) {
