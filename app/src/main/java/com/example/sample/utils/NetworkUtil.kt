...
class NetworkUtil(private val context: Context) {
    ...
    init {
        ...
        bldr.setMessage("Not connected to internet")
    ...
    fun init() {
        ...
        context.registerReceiver(SyncOnConnectivityReceiver(), filter)
    }
    ...
    inner class SyncOnConnectivityReceiver : BroadcastReceiver() {
