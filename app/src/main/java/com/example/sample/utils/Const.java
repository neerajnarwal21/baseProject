...
public class Const {
    ...
    public static String IMAGE_BASE_URL = "http://devphp.pugmarks.in/screip/uploads/";
    public static String IMAGE_BASE_URL_STORE = "http://devphp.pugmarks.in/screip/assets/img/profile/";
